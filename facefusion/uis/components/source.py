...
def render() -> None:
	...
	source_file_names_2 = [source_file_value['name'] for source_file_value in SOURCE_FILE_2.value] if SOURCE_FILE_2.value else None
...
def update_2(files : List[File]) -> Tuple[gradio.Audio, gradio.Image]:
	...
	if has_source_audio or has_source_image:
		...
		return gradio.Image(value = source_image_path, visible = has_source_image)
